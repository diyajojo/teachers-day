...
export default function Home() {
  return (
    <div className="min-h-screen bg-[#2e1f14] overflow-hidden flex items-center justify-center relative">

      {/* Paper clip — pinned at the top, slightly offset to match the tilt */}
      <div className="absolute top-[2vh] md:top-[2.5vh] left-[49%] z-50 pointer-events-none -rotate-[1.5deg]">
