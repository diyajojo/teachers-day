...
export default function Home() {
  return (
    <div className="min-h-screen bg-[#2e1f14] overflow-hidden flex items-center justify-center relative p-2 md:p-0">
      ...
      <div className="absolute top-[1vh] md:top-[2.5vh] left-[49%] z-50 pointer-events-none -rotate-[1.5deg]">
      ...
      <div
        className="canvas-texture bg-[#faf6f0] w-[96vw] h-[96vh] md:w-[94vw] md:h-[92vh] rounded-xl md:rounded-2xl flex flex-col relative shadow-[0_15px_40px_rgba(0,0,0,0.5)] md:shadow-[0_25px_80px_rgba(0,0,0,0.6)] overflow-y-auto overflow-x-hidden"
